...
\title[Template REIC 2025 for works in English]{Presenting the REIC template for 2025 - Version for works in English}
...
THIS DECLARATION IS DESIRABLE. Additional relevant information, such as approval by an ethics committee or the use of generative AI tools in the development of the article. This statement is optional; if there is nothing to add, it can be left blank.
