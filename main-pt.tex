...
\title[Template da REIC 2025 para artigos em português]{Plataforma Web com Inteligência Artificial para Identificação de Doenças em Plantas}
...
\affil{\textbf{Maria Quaresma}~\orcidlink{0000-0002-0339-6624}~\textcolor{blue}{\faEnvelopeO}~~[{Centro Federal de Educação Tecnologica Celso Sucknow da Fonseca (CEFET)}~|\href{mailto:maria.rocha@aluno.cefet-rj.br}{~{\textit{maria.rocha@aluno.cefet-rj.br}}}~]}

\affil{\textbf{Neemias Cruz}~\orcidlink{0000-0002-7110-2026}~\textcolor{blue}{\faEnvelopeO}~~[{Centro Federal de Educação Tecnologica Celso Sucknow da Fonseca (CEFET)}~|\href{mailto:neemiascruz@hotmail.com}{{\textit{neemiascruz@hotmail.com}}}~]}
...
\begin{mail}
Centro Federal de Educação Tecnologica Celso Sucknow da Fonseca (CEFET), R. Miguel Ângelo, 96 - Maria da Graça, Rio de Janeiro - RJ, 20785-220, Brasil. 
\end{mail}
