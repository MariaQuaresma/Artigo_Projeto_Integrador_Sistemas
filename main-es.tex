...
\category{Artículo de investigación/Research Paper}
\title[Plantilla REIC 2025 para obras en español]{Presentación de la plantilla REIC para 2025 - Versión para artículos en español}
...
\affil{\textbf{José Viterbo}~\orcidlink{0000-0002-0339-6624}~\textcolor{blue}{\faEnvelopeO}~~[{Universidad Federal Fluminense}~|\href{mailto:viterbo@ic.uff.br}{~{\textit{viterbo@ic.uff.br}}}~]}

\affil{\textbf{Clodis Boscarioli}~\orcidlink{0000-0002-7110-2026}~~[{Universidad Estatal del Oeste de Paraná}~|\href{mailto:clodis.boscarioli@unioeste.br}{{\textit{clodis.boscarioli@unioeste.br}}}~]}

\affil{\textbf{Roberto Pereira}~\orcidlink{0000-0003-3052-3016}~~[{Universidad Federal de Paraná}~|\href{mailto:rpereira@inf.ufpr.br}{{\textit{rpereira@inf.ufpr.br}}}~]}

\affil{\textbf{Cristiano Maciel}~\orcidlink{0000-0002-2431-8457}~~[{Universidad Federal de Mato Grosso~}|\href{mailto:cmaciel@ufmt.br}{{\textit{cmaciel@ufmt.br}}}~]}
...
\begin{abstract-es}
Este texto, en formato de artículo científico, presenta el nuevo modelo para artículos de SBC, describiendo sus principales características y explicando su uso. Esta versión, en concreto, debe utilizarse exclusivamente para artículos escritos en portugués que se publicarán en alguna serie de actas de eventos en SBC OpenLib. El resumen en portugués, como se muestra en este ejemplo, debe preceder al resumen en inglés y tener entre 500 y 750 palabras.
\end{abstract-es}
...
\begin{pclaves}
Actas de congresos, Modelo, SBC OpenLib, Indexación
\end{pclaves}
...
\noindent
{\sffamily\textbf{Recibido/Received:}} DD Month YYYY~~~$\bullet$~~~
{\sffamily\textbf{Aceptado/Accepted:}} DD Month YYYY~~~$\bullet$~~~
